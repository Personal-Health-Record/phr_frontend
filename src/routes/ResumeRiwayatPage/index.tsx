...
import { dummyResumeData } from "../ResumePage/constants";
import Header from "../HomePage/components/Header";
import Timeline from "../ResumePage/components/Timeline";
import Pagination from "../ResumePage/components/Pagination";
